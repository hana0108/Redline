...
VEHICLES: list[tuple] = [
    ...
    (2, 0, "Toyota", "Hilux", 2021, 52000, 28000, "Plata", "Automática", "Diésel", "Pickup", _D),
    (
        3,
        0,
        "Toyota",
    ...
    (4, 0, "Chevrolet", "Captiva", 2021, 32000, 22000, "Gris", "Automática", "Gasolina", "SUV", _R),
    (5, 0, "Chevrolet", "D-Max", 2020, 38000, 45000, "Blanco", "Manual", "Diésel", "Pickup", _V),
    (6, 0, "Ford", "Ranger", 2021, 48000, 31000, "Plata", "Automática", "Diésel", "Pickup", _D),
    (7, 0, "Ford", "Explorer", 2022, 65000, 15000, "Negro", "Automática", "Gasolina", "SUV", _D),
    (8, 0, "Hyundai", "Tucson", 2021, 36000, 27000, "Rojo", "Automática", "Gasolina", "SUV", _D),
    (
        9,
        0,
        "Hyundai",
    ...
    (10, 0, "Nissan", "Frontier", 2021, 44000, 29000, "Plata", "Manual", "Diésel", "Pickup", _D),
    (11, 0, "Nissan", "X-Trail", 2022, 38500, 18000, "Gris", "Automática", "Gasolina", "SUV", _D),
    (12, 0, "Kia", "Sportage", 2022, 39000, 14000, "Azul", "Automática", "Gasolina", "SUV", _D),
    (13, 0, "Honda", "CR-V", 2021, 42000, 22000, "Plata", "Automática", "Gasolina", "SUV", _D),
    (
        14,
        0,
        "Volkswagen",
    ...
    (15, 0, "Jeep", "Wrangler", 2022, 78000, 8000, "Rojo", "Automática", "Gasolina", "SUV", _D),
    (16, 0, "Mazda", "CX-5", 2021, 38000, 20000, "Gris", "Automática", "Gasolina", "SUV", _D),
    (17, 0, "Toyota", "RAV4", 2020, 41000, 34000, "Blanco", "Automática", "Gasolina", "SUV", _V),
    # ── Sucursal 1: Caracas Este (16 vehículos) ───────────────────────────────
    (18, 1, "Toyota", "Fortuner", 2021, 68000, 19000, "Negro", "Automática", "Diésel", "SUV", _R),
    (19, 1, "Toyota", "Camry", 2018, 28000, 72000, "Dorado", "Automática", "Gasolina", "Sedán", _V),
    (20, 1, "Chevrolet", "Aveo", 2019, 9800, 88000, "Rojo", "Manual", "Gasolina", "Sedán", _D),
    (21, 1, "Chevrolet", "Sail", 2020, 12500, 61000, "Azul", "Automática", "Gasolina", "Sedán", _D),
    (22, 1, "Ford", "F-150", 2021, 62000, 24000, "Plata", "Automática", "Gasolina", "Pickup", _D),
    (23, 1, "Hyundai", "Santa Fe", 2022, 52000, 11000, "Gris", "Automática", "Gasolina", "SUV", _D),
    (24, 1, "Hyundai", "Creta", 2022, 29500, 16000, "Blanco", "Automática", "Gasolina", "SUV", _R),
    (25, 1, "Nissan", "Kicks", 2022, 28000, 17000, "Naranja", "Automática", "Gasolina", "SUV", _D),
    (
        26,
        1,
        "Mitsubishi",
    ...
    (28, 1, "Kia", "Sorento", 2022, 55000, 10000, "Azul", "Automática", "Gasolina", "SUV", _D),
    (29, 1, "Honda", "Accord", 2022, 38500, 14000, "Negro", "Automática", "Gasolina", "Sedán", _D),
    (
        30,
        1,
        "Volkswagen",
    ...
    (34, 2, "Toyota", "Hilux", 2020, 46000, 55000, "Gris", "Manual", "Diésel", "Pickup", _V),
    ...
    (37, 2, "Chevrolet", "Aveo", 2018, 8200, 102000, "Azul", "Manual", "Gasolina", "Sedán", _D),
    (38, 2, "Ford", "Ranger", 2020, 44000, 49000, "Negro", "Automática", "Diésel", "Pickup", _V),
    (39, 2, "Ford", "Escape", 2020, 31000, 42000, "Plata", "Automática", "Gasolina", "SUV", _D),
    (
        40,
        2,
        "Hyundai",
    ...
    (42, 2, "Mitsubishi", "L200", 2021, 48000, 31000, "Plata", "Manual", "Diésel", "Pickup", _D),
    (43, 2, "Kia", "Cerato", 2021, 22000, 33000, "Rojo", "Automática", "Gasolina", "Sedán", _D),
    ...
    (46, 2, "Jeep", "Compass", 2022, 45000, 14000, "Gris", "Automática", "Gasolina", "SUV", _D),
    (47, 2, "Renault", "Logan", 2019, 10500, 78000, "Plata", "Manual", "Gasolina", "Sedán", _D),
    (
        48,
        2,
        "Renault",
    ...
    (49, 2, "Mazda", "Mazda 3", 2020, 22000, 44000, "Negro", "Automática", "Gasolina", "Sedán", _D),
    # ── Sucursal 3: Valencia (16 vehículos) ───────────────────────────────────
    (50, 3, "Toyota", "Hilux", 2019, 42000, 68000, "Plata", "Manual", "Diésel", "Pickup", _V),
    (
        51,
        3,
        "Toyota",
    ...
    (54, 3, "Ford", "Ranger", 2019, 40000, 71000, "Blanco", "Manual", "Diésel", "Pickup", _V),
    (55, 3, "Ford", "EcoSport", 2020, 22000, 50000, "Rojo", "Automática", "Gasolina", "SUV", _D),
    (56, 3, "Hyundai", "Tucson", 2020, 31000, 58000, "Plata", "Automática", "Gasolina", "SUV", _V),
    (
        57,
        3,
        "Nissan",
    ...
    (58, 3, "Nissan", "X-Trail", 2021, 36000, 30000, "Gris", "Automática", "Gasolina", "SUV", _R),
    (
        59,
        3,
        "Mitsubishi",
    ...
    (60, 3, "Mitsubishi", "L200", 2020, 44000, 47000, "Plata", "Manual", "Diésel", "Pickup", _R),
    (61, 3, "Kia", "Stinger", 2020, 38000, 41000, "Gris", "Automática", "Gasolina", "Sedán", _D),
    (62, 3, "Honda", "Pilot", 2022, 62000, 9000, "Negro", "Automática", "Gasolina", "SUV", _D),
    (
        63,
        3,
        "Volkswagen",
    ...
    (64, 3, "Jeep", "Gladiator", 2021, 72000, 22000, "Naranja", "Manual", "Diésel", "Pickup", _V),
    (65, 3, "Kia", "Seltos", 2021, 27500, 35000, "Azul", "Automática", "Gasolina", "SUV", _V),
    # ── Sucursal 4: Barquisimeto (16 vehículos) ───────────────────────────────
    (66, 4, "Toyota", "RAV4", 2021, 43000, 26000, "Blanco", "Automática", "Gasolina", "SUV", _D),
    (67, 4, "Toyota", "Fortuner", 2020, 62000, 38000, "Negro", "Automática", "Diésel", "SUV", _E),
    (68, 4, "Toyota", "Hiace", 2018, 34000, 82000, "Blanco", "Manual", "Diésel", "Van", _D),
    (69, 4, "Chevrolet", "Sail", 2019, 11500, 74000, "Verde", "Manual", "Gasolina", "Sedán", _V),
    (
        70,
        4,
        "Chevrolet",
    ...
    (71, 4, "Ford", "Bronco", 2022, 74000, 7000, "Naranja", "Automática", "Gasolina", "SUV", _R),
    (72, 4, "Nissan", "Frontier", 2020, 42000, 52000, "Plata", "Manual", "Diésel", "Pickup", _V),
    (73, 4, "Nissan", "Navara", 2021, 48000, 28000, "Negro", "Manual", "Diésel", "Pickup", _D),
    (
        74,
        4,
        "Mitsubishi",
    ...
    (75, 4, "Kia", "Sportage", 2021, 35500, 31000, "Rojo", "Automática", "Gasolina", "SUV", _R),
    (76, 4, "Honda", "HR-V", 2021, 27000, 38000, "Gris", "Automática", "Gasolina", "SUV", _V),
    (
        77,
        4,
        "Volkswagen",
    ...
    (78, 4, "Mazda", "BT-50", 2021, 46000, 35000, "Plata", "Manual", "Diésel", "Pickup", _V),
    (79, 4, "Hyundai", "H-1", 2019, 32000, 68000, "Blanco", "Manual", "Diésel", "Van", _D),
    (
        80,
        4,
        "Hyundai",
